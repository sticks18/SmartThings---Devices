/*
    ...
    For Color Loop to work, you need to update the firmware. Also, only EU Osram bulbs will receive the color loop
    functionality at this time due to differences in EU vs US firmware. Osram support told me that the two will merge
    when the new version of Zigbee is available.
*/

metadata {
    definition (name: "Improved OSRAM LIGHTIFY Gardenspot mini RGB MA", namespace: "sticks18", author: "Scott G") {
